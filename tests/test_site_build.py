...
class MkDocsSiteBuildTest(unittest.TestCase):
    ...
    def test_mkdocs_build_renders_homepage_profile_and_publication_card(self):
        ...
        self.assertIn("https://orcid.org/my-orcid?orcid=0009-0005-4075-897X", index_html)
        ...
        self.assertIn("assets/icons/email.svg", index_html)
        ...
        selected_publications_pos = index_html.index('id="selected-publications"')
        education_pos = index_html.index('id="education"')
        self.assertLess(news_pos, selected_publications_pos)
        self.assertLess(selected_publications_pos, education_pos)
        ...
        self.assertIn("assets/img/publication-placeholder.svg", index_html)
        ...
        self.assertIn('id="accepted"', publications_html)
