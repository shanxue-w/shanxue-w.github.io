...
class MkDocsSiteBuildTest(unittest.TestCase):
    ...
    def test_mkdocs_build_renders_homepage_profile_and_publication_card(self):
        ...
        self.assertIn("haowang@u.nus.edu", index_html)
        ...
        self.assertIn('href="mailto:haowang@u.nus.edu"', index_html)
        ...
        self.assertIn("supervised by Prof. Zhenning Cai", index_text)
        self.assertIn('href="https://blog.nus.edu.sg/matcz/">Prof. Zhenning Cai</a>', index_html)
        self.assertIn("I received my B.S. in Mathematics and Applied Mathematics from Zhejiang University in 2026.", index_text)
        self.assertIn("conservation, positivity, entropy dissipation, and geometric structure", index_text)
        self.assertIn("kinetic equations and conservation laws", index_text)
        ...
        self.assertNotIn("Will begin Ph.D. studies", index_text)
        self.assertIn("Learning missing physics from legacy simulators with alternating neural integrators", index_text)
        self.assertIn('href="https://doi.org/10.1038/s41467-026-74002-2">DOI</a>', index_html)
        ...
        self.assertIn("Hao Wang, Chi-Wang Shu, and Qi Tang. In revision, 2026.", publications_text)
        ...
        self.assertIn("In revision, <strong>2026</strong>.", publications_html)
