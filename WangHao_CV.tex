...
\newcommand{\placelastupdatedtext}{% \placetextbox{<horizontal pos>}{<vertical pos>}{<stuff>}
  \AddToShipoutPictureFG*{% Add <stuff> to current page foreground
    \put(
        ...
        \small\color{gray}\textit{Last updated in 2026.07}\hspace{\widthof{Last updated in 2026.07}}
    }}}%
  }%
}%
...
\begin{document}
    ...
    \begin{header}
        ...
        \normalsize
        \mbox{Ph.D. Student, Department of Mathematics, National University of Singapore (NUS)}%
        ...
        \AND%
        \kern 5.0 pt%
        \mbox{wanghaomathe@gmail.com}%
        \kern 5.0 pt%
        \AND%
        \kern 5.0 pt%
        \mbox{+86 152 7099 8779}%
        \kern 5.0 pt%
    \end{header}
    ...
    \section{EDUCATION}
        ...
        \begin{twocolentry}{
            ...
            \textbf{National University of Singapore (NUS)}, Ph.D. in Mathematics
        \end{twocolentry}
        ...
        \begin{twocolentry}{
            ...
            \textbf{Zhejiang University}, B.S. in Mathematics and Applied Mathematics
        \end{twocolentry}
    ...
    \section{PUBLICATIONS \& MANUSCRIPTS}
        \begin{onecolentry}
            \begin{highlights}
                \item \textbf{Hao Wang}, Qinghe Wang, Caiyou Yuan, Kailiang Wu. "Learning missing physics from legacy simulators with alternating neural integrators." \textbf{Manuscript accepted}, 2026.
            \end{highlights}
        \end{onecolentry}
    ...
    \section{RESEARCH EXPERIENCE}
        \begin{twocolentry}{
            ...
            \textit{Georgia Institute of Technology (Supervisor: Prof. Qi Tang)}
        \end{twocolentry}
    ...
    \section{RESEARCH PROJECTS}
        \begin{twocolentry}{
            ...
            \textit{Supervisor: Prof. Heyu Wang} % Added supervisor line
        \end{twocolentry}
    ...
    \section{SEMINARS \& READING GROUPS}
        \begin{onecolentry}
            \begin{highlights}
                \item \textbf{Fourier Analysis Reading Group}, Zhejiang University. 2024.07  
    ...
    \section{LEADERSHIP \& INITIATIVES}
        \begin{twocolentry}{
             2024.06-Present % e.g., 2023.10-Present
        }
